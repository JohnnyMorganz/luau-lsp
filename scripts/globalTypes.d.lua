...
declare class MaterialGenerationService extends Instance
	...
	function DEPRECATED_UploadMaterialVariantsAsync(self, materialVaraints: { Instance }): nil
...
declare class Moderation extends Instance
