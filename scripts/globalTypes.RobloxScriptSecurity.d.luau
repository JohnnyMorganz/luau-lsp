...
declare extern type EnumHandRigDescriptionSide extends EnumItem with end
declare extern type EnumHandRigDescriptionSide_INTERNAL extends Enum with
...
declare extern type EnumMoverConstraintRootBehaviorMode extends EnumItem with end
declare extern type EnumMoverConstraintRootBehaviorMode_INTERNAL extends Enum with
...
declare extern type AudioEmitter extends Instance with
	...
	SimulationFidelity: EnumAudioSimulationFidelity
	WiringChanged: RBXScriptSignal<boolean, string, Wire, Instance>
...
declare extern type AvatarPreloader extends Instance with
	function PreloadModelAssets(self, models: { Instance }): { any }
end
...
declare extern type ChatbotUIService extends Instance with
...
declare extern type ConversationalAIAcceptanceService extends Instance with
...
declare extern type ExampleService extends Instance with
...
declare extern type HandRigDescription extends Instance with
	Index1: Instance
...
declare extern type LSPFileSyncService extends Instance with
end
...
declare extern type ClientReplicator extends NetworkReplicator with
	...
	function RequestServerLuauHeapData(self): nil
	function RequestServerScriptProfiling(self, start: boolean, frequency: number?): nil
	function RequestServerScriptProfilingData(self): nil
...
declare extern type Workspace extends WorldRoot with
	...
	UseImprovedModelLod: EnumRolloutState
...
declare extern type EmotesPages extends InventoryPages with
end
...
declare extern type RecommendationService extends Instance with
	...
	function RegisterItemAsync(self, registerRecommendationItemsRequest: { [any]: any }): { [any]: any }
...
declare extern type SocialService extends Instance with
	...
	function PromptRsvpToEventCompleted(self, eventId: string, success: boolean, rsvpStatus: EnumRsvpStatus): nil
...
declare extern type StudioAssetService extends Instance with
	...
	function AutoSetupSerializedAvatarAsync(self, serializedInstance: string, publishInfo: { [any]: any }, progressCallback: ((...any) -> ...any), notificationCallback: ((...any) -> ...any)?): Instance
...
declare extern type UGCValidationService extends Instance with
	...
	function ValidateMeshTriangleArea(self, meshId: string): boolean
	...
	function ValidateUVDuplicates(self, referenceValues: { any }, meshId: string): number
...
declare extern type UIContainerQuery extends UIComponent with
	Active: boolean
