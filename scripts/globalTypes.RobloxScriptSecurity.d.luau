...
declare class EnumVideoCaptureResult_INTERNAL extends Enum
	CapturingAlready: EnumVideoCaptureResult
	NoDeviceSupport: EnumVideoCaptureResult
	NoSpaceOnDevice: EnumVideoCaptureResult
...
declare class CaptureService extends Instance
	...
	function StartVideoCaptureAsync(self, onCaptureReady: ((...any) -> ...any), captureParams: { [any]: any }?): EnumVideoCaptureResult
	function StartVideoCaptureInternalAsync(self): EnumVideoCaptureResult
