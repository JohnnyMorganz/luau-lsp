...
- Fixed syntax highlighting incorrectly coloring digit sequences inside identifiers (e.g. the `2014` in `Website2014Components`) as numeric literals. The decimal number grammar pattern was missing the `\b` word-boundary anchor present on the hex and binary patterns
