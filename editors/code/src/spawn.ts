...
const spawnNaive = (command: string, args: string[], options?: SpawnOptionsWithoutStdio): Promise<string> => {
...
const wrappedSpawn = (command: string, args: string[], options?: SpawnOptionsWithoutStdio): Promise<string> => {
	return new Promise((resolve, reject) => {
